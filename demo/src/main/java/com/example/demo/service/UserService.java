...
@Autowired
    ...
    public UserEntity getPersonByName(String name){
        UserEntity userEntity = userRepository.findByNameContaining(name);
        return userEntity;
    }
    ...
    public ResponseEntity<UserEntity> updatePersonByName(String userName, Map<String,Object> userEntity){
        Optional<UserEntity> optionalUserEntity = userRepository.findByNameContainingIgnoreCase(userName);//Used optional for null safety purposes
    ...
    //delete user by name
    public ResponseEntity<HttpStatus> deletePersonByName(String userName){
        UserEntity userToDelete = userRepository.findByNameContaining(userName);
        if(userToDelete==null){
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
        }
        userRepository.delete(userToDelete);
